...
// Restore the basic working version without bullet formatting
const basicContent = `/**
...
const lotA = require('../../../docs/lotA.txt');
const lotB = require('../../../docs/lotB.txt');
const lotC = require('../../../docs/lotC.txt');

// Format contracts for template string
...
const CONTRAT_LOT_A = formatContract(lotA);
const CONTRAT_LOT_B = formatContract(lotB);
const CONTRAT_LOT_C = formatContract(lotC);
...
console.log('Restored basic docxEngine.ts');
