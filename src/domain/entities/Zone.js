...
export class Zone extends (EntityLocal || window.Entity) {
    ...
    constructor(id, name, totalHouses, projectId = null) {
        ...
        this._grappe = null; // Groupe de villages
    ...
    static fromJSON(data) {
        ...
        zone._config = data.config || {};
        zone._metadata = data.metadata || {};
