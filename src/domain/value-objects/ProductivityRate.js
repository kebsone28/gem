...
(function () {
    ...
    class ProductivityRate {
        ...
        static fromDefaults(teamType) {
            const defaultRate = DEFAULT_PRODUCTIVITY_LOCAL ? DEFAULT_PRODUCTIVITY_LOCAL[teamType] : null;
            if (!defaultRate) {
                console.warn(`No default productivity for team type: ${teamType}, using fallback (5)`);
                return new ProductivityRate(5, teamType);
            }
