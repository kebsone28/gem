...
import { Users, CheckCircle2, TrendingUp, MapPin, FileText, ArrowRight, Activity, ShieldCheck } from 'lucide-react';
                    ...
                    <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-4">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-black text-blue-400/40 uppercase tracking-[0.3em] font-mono italic">PROJECT STATUS REAL-TIME</span>
                            </div>
                            <h2 className="text-5xl md:text-6xl font-black italic uppercase tracking-tighter leading-[0.8]">
                                SUIVI <span className="text-blue-500 drop-shadow-[0_0_15px_rgba(59,130,246,0.3)]">DYNAMIQUE</span>
                            </h2>
                        </div>
                        <button
                            ...
                            <div className="flex-1 w-full space-y-8">
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-baseline gap-4">
                                        <span className="text-8xl md:text-9xl font-black text-white tracking-tighter italic leading-none drop-shadow-xl">{pct}%</span>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between text-[9px] font-black text-slate-600 uppercase tracking-widest italic font-mono">
                                        ...
                                        <span className="text-white/60">{fmtNum(done)} / {fmtNum(total)} UNITS COMPLETED</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-8 p-10 rounded-[3rem] bg-slate-900/40 border border-white/5 backdrop-blur-3xl shadow-2xl">
                            <div className="flex items-center justify-between mb-12 pb-8 border-b border-white/5">
                                ...
                                <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest italic">{topRegions.length} ACTIVE CLUSTERS</p>
                            </div>
                        ...
                        <div className="lg:col-span-4 p-10 rounded-[3rem] bg-slate-900/40 border border-white/5 backdrop-blur-3xl shadow-2xl flex flex-col">
                            ...
                            {recentValidated.length > 0 ? (
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="text-[9px] font-black text-blue-400/40 uppercase tracking-widest truncate mt-1 italic leading-none">{zone?.name ?? 'OPS ZONE UNKNOWN'}</p>
                                                </div>
                                            </motion.div>
                                        );
                                    })}
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center text-center py-20 space-y-6 opacity-20 border border-dashed border-white/10 rounded-[2rem]">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] italic">AWAITING FIELD AGENT VALIDATION</p>
                                    <button onClick={() => navigate('/rapports')} className="text-blue-400 font-black text-[10px] flex items-center gap-3 hover:text-white transition-all uppercase tracking-widest italic group">
                                        ACCESS FULL ARCHIVE <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform" />
                                    </button>
                                </div>
                            )}
                        </div>
