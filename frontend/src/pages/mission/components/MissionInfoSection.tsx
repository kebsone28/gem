...
export const MissionInfoSection: React.FC<MissionInfoSectionProps> = ({
  ...
  const inputClass = (locked: boolean) => `w-full ${locked ? 'bg-slate-100 dark:bg-white/5 cursor-not-allowed opacity-80 font-black text-slate-400' : 'bg-slate-50 dark:bg-white/5 text-indigo-900 dark:text-indigo-100'} border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2 text-[11px] font-bold focus:ring-2 ring-indigo-500/20 transition-all outline-none`;
  return (
    <section className="glass-card !p-5 !rounded-[2rem] space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {/* N° Ordre */}
        <div className="space-y-1.5">
          <label htmlFor="mission-number" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            N° Ordre
          </label>
        ...
        {/* Destination */}
        <div className="space-y-1.5">
          <label htmlFor="mission-region" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Destination
          </label>
          <input 
            id="mission-region" 
        ...
        {/* Date Début */}
        <div className="space-y-1.5">
          <label htmlFor="mission-start" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Début
          </label>
          <input 
            id="mission-start" 
        ...
        {/* Date Fin */}
        <div className="space-y-1.5">
          <label htmlFor="mission-end" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Fin Estimée
          </label>
          <input 
            id="mission-end" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-slate-100 dark:border-white/5">
        ...
        <div className="space-y-1.5 md:col-span-2">
          <label htmlFor="mission-purpose" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Objet de la mission
          </label>
          <input 
            id="mission-purpose" 
        ...
        {/* Moyen de transport */}
        <div className="space-y-1.5">
          <label htmlFor="mission-transport" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Moyen de transport
          </label>
          <input 
        ...
        {/* Itinéraire Aller */}
        <div className="space-y-1.5">
          <label htmlFor="mission-itinerary-aller" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Itinéraire Aller
          </label>
          <input 
        ...
        {/* Itinéraire Retour */}
        <div className="space-y-1.5">
          <label htmlFor="mission-itinerary-retour" className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">
            Itinéraire Retour
          </label>
          <input 
