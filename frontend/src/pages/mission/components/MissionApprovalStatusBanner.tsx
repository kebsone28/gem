    ...
    return (
      <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-2xl p-4 flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-[10px] font-black text-indigo-500 uppercase tracking-widest leading-none mb-1">
    ...
    <div className={`${bgColor} border rounded-[2rem] p-6 mb-8 relative overflow-hidden group`}>
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div
            className={`w-14 h-14 rounded-2xl ${isApproved ? 'bg-emerald-500/20' : isRejected ? 'bg-rose-500/20' : 'bg-amber-500/20'} flex items-center justify-center shadow-xl`}
          >
