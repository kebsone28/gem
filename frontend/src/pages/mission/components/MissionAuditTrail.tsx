  ...
  return (
    <section className="glass-card !p-5 !rounded-[2rem] space-y-4">
      <div className="flex items-center gap-3 border-b border-slate-100 dark:border-white/5 pb-3">
        ...
        <div>
          <h2 className="text-slate-900 dark:text-white font-black uppercase tracking-widest text-[10px]">Journal d'Audit</h2>
          <p className="text-[8px] text-slate-400 font-bold uppercase tracking-tight">Traçabilité & Historique SaaS</p>
        </div>
      </div>
