...
export type MissionAction =
  ...
  | { type: 'LOAD_MISSION'; payload: { id: string | null; data: Partial<MissionOrderData>; members: MissionMember[]; version?: number; updatedAt?: string; auditTrail?: AuditEntry[] } }
  | { type: 'RESET_MISSION'; payload: { orderNumber: string; date: string; planning: string[]; createdBy?: string; creatorId?: string; } }
  ...
  | { type: 'ADD_AUDIT_ENTRY'; payload: { action: string; author: string; details?: string; diff?: any } };
