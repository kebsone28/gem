                ...
                actions={
                    <ActionBar>
                        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-100 dark:bg-blue-900/50 border border-blue-600 dark:border-blue-600">
                            ...
                            <span className="text-xs font-black text-blue-900 dark:text-blue-100 uppercase tracking-widest leading-none">Live Data</span>
                        </div>
                        <button
                ...
                <div className="h-full">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center h-full space-y-6">
                            <div className={`w-12 h-12 border-4 rounded-full animate-spin ${isDarkMode ? 'border-slate-700 border-t-blue-500' : 'border-slate-200 border-t-blue-500'}`} />
