            ...
            <PageHeader
                ...
                actions={
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                        ...
                        <div className={`${COMMON_CLASSES.card} p-1 rounded-2xl flex overflow-x-auto scrollbar-none transition-all w-full sm:w-auto`}>
                            <button
            ...
            <div className={`${COMMON_CLASSES.card} p-6 md:p-12 overflow-hidden relative shadow-2xl ${isDarkMode ? 'bg-indigo-600' : 'bg-gray-900'}`}>
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5 md:gap-8">
                    <div>
                        ...
                        <p className={`${COMMON_CLASSES.body} text-indigo-100/70 text-xs md:text-sm max-w-xl`}>Générez une analyse financière détaillée incluant tous les postes de dépense et les projections de marge.</p>
                    </div>
