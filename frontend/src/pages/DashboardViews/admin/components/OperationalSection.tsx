      ...
      <div className="lg:col-span-8 space-y-6 sm:space-y-8 lg:space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
          <div className="p-4 sm:p-6 md:p-10 rounded-[1.8rem] sm:rounded-3xl md:rounded-[3rem] bg-slate-900/40 border border-white/5 backdrop-blur-3xl shadow-xl">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex justify-between items-center gap-4 bg-white/[0.03] p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-white/5 group hover:bg-white/[0.05] transition-all">
                <span className="text-[10px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.06em] sm:tracking-widest italic group-hover:text-blue-400 transition-colors">KITS DÉPLOYÉS</span>
                <span className="text-xl sm:text-2xl font-black text-white italic">{fmtNum(metrics.logistics.kitPrepared)}</span>
              </div>
              <div className="flex justify-between items-center gap-4 bg-white/[0.03] p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-white/5 group hover:bg-white/[0.05] transition-all">
                <span className="text-[10px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.06em] sm:tracking-widest italic group-hover:text-blue-400 transition-colors">CÂBLE MOYEN / MÉNAGE</span>
              ...
              <div className="flex justify-between items-center gap-4 bg-rose-500/5 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-rose-500/10">
                <span className="text-[10px] sm:text-[10px] font-black text-rose-400/80 uppercase tracking-[0.06em] sm:tracking-widest italic">ÉCART LOGISTIQUE</span>
          ...
          <div className="p-4 sm:p-6 md:p-10 rounded-[1.8rem] sm:rounded-3xl md:rounded-[3rem] bg-slate-900/40 border border-white/5 backdrop-blur-3xl shadow-xl flex flex-col">
            <h3 className="text-[11px] sm:text-[11px] font-black text-blue-300/65 uppercase tracking-[0.08em] sm:tracking-[0.28em] mb-3 sm:mb-4 italic flex items-center gap-2 sm:gap-3 text-white">
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-3 sm:py-6">
              <div className="text-4xl sm:text-7xl font-black text-white italic tracking-tighter drop-shadow-xl">{metrics.performance.avgPerDay}</div>
              <p className="text-[10px] sm:text-[10px] font-black text-blue-300/65 uppercase tracking-[0.08em] sm:tracking-[0.24em] mt-2 italic">RENDEMENT MOYEN / JOUR</p>
