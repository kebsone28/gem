...
export const ELECTRICIAN_GUIDE: Record<string, TechnicalDefinition> = {
  ...
  projet_mfr_eligibilite: {
    ...
    specs: [
      'Proximité avec le réseau Senelec',
      'Condition de revenu faible',
      'Propriétaire exclusif de la maison ou dépendance',
      'Construction en dur (ciment ou banco)',
      'Aucune installation électrique ou compteur pré-existant',
    ],
  ...
  projet_mfr_interieur: {
    ...
    specs: [
      'Coffret disjoncteur dans un couloir couvert (ou mur clos de pièce adossée)',
      'Interrupteurs strictement en zone couverte',
      'Configuration standard : 3 lampes et 1 prise',
      'Hublots étanches requis en extérieur',
    ...
    images: [
      {
        url: '/guide_images/schema_interieur.jpg',
        caption: "Schéma de principe de l'installation intérieure",
      },
    ],
  },
  projet_mfr_branchement: {
    ...
    specs: [
      "Coffret compteur fixé STRICTEMENT en limite de propriété (jamais à l'intérieur)",
      "Câble de branchement : ne jamais surplomber d'autres maisons",
      'Hublot du coffret à 1.60m du sol',
      'Hauteur de câble à minima de 4m (ruelles) ou 6m (traversée routière)',
    ...
    images: [
      {
        url: '/guide_images/schema_branchement_urbain.jpg',
        caption: 'Branchement Milieu Urbain : Arrêt à la 2ème position',
      },
      {
        url: '/guide_images/schema_branchement_rural.png',
        caption: 'Branchement Milieu Rural : Arrêt à la 3ème position',
      },
      {
        url: '/guide_images/exemple_coffret_compteur.png',
        caption: 'Exemple de pose conforme (Concession multiple)',
      },
      ...
      {
        url: '/guide_images/exemple_pose_limite_propriete.jpg',
        caption: 'Pose en limite de propriété (Milieu Rural)',
      },
    ],
  },
  projet_mfr_anomalies: {
    ...
    description:
      "Liste des défauts techniques majeurs entraînant un rejet d'installation géographique ou sécuritaire.",
    specs: [
      'Fils conducteurs visibles après pose (utilisation de pince interdite, utiliser un cutteur)',
      'Câbles placés en plein air (doivent être dans la chambre/couloir)',
      "Barrette de terre à l'extérieur (interdit)",
    ...
    images: [
      {
        url: '/guide_images/anomalie_conducteur_visible.png',
        caption: '❌ À ÉVITER : Conducteurs visibles',
      },
      {
        url: '/guide_images/anomalie_decoupe_pince.png',
      ...
      {
        url: '/guide_images/anomalie_barette_terre.png',
        caption: "❌ À ÉVITER : Barrette de terre à l'extérieur",
      },
      {
        url: '/guide_images/exemple_barette_terre.png',
        caption: '✅ Exemple de barrette de terre interne',
      },
      {
        url: '/guide_images/anomalie_poteau_bois_pourri.png',
  ...
  norme_ns_01_001_domaine: {
    ...
    description:
      "Frontières légales d'application de la norme sénégalaise pour les installations BT.",
    specs: [
      'Tension autorisée : ≤ 1000 V (AC) / ≤ 1500 V (DC)',
      'Cible : Habitations, ERP, commerces, chantiers, marinas',
  ...
  ns01_terms: {
    ...
    description:
      'Ensemble des définitions normatives essentielles pour la conformité et la sécurité des installations électriques au Sénégal.',
    specs: [
  ...
  norme_ns_01_001_protection: {
    ...
    specs: [
      'Contacts Directs : Protection contre le contact avec les parties actives',
      'Contacts Indirects : Coupure automatique obligatoire en cas de défaut sur masse (ex: DDR)',
      'Surintensités : Protection stricte contre surcharges et courts-circuits',
  ...
  ns01_characteristics: {
    ...
    description:
      "Règles pour définir la structure technique, la puissance et le mode de protection d'une installation avant sa réalisation.",
    specs: [
  ...
  ns01_safety: {
    ...
    description:
      'Directives fondamentales pour la protection des biens et des personnes contre les risques thermiques, électriques et atmosphériques.',
    specs: [
  ...
  compteur: {
    ...
    description:
      'Organe de mesure sacré de la consommation. Doit être scellé et inaccessible sans autorisation.',
  ...
  ns01_iei_domestic: {
    ...
    description:
      'Règles spécifiques pour la mise en conformité des branchements et circuits intérieurs des ménages (Projet MFR).',
    specs: [
  ...
  ns01_erp_ert: {
    ...
    description:
      "Exigences strictes pour les bâtiments recevant du public ou du personnel, avec focus sur la sécurité incendie et l'évacuation.",
    specs: [
