...
export const MISSION_TEMPLATES = {
  electrification: {
    ...
    template: {
      ...
      planning: [
        'Jour 1 : Mobilisation & Briefing\n• Départ matinal depuis Dakar\n• Installation base vie\n• Réunion avec autorités locales\n• Briefing équipe terrain',
        'Jour 2 : Prospection Secteur Nord\n• Relevés GPS des grappes\n• Audit accès routier\n• Photos état initial des sites\n• Identification lieux stockage',
        'Jour 3 : Prospection Secteur Sud\n• Extension couverte géographique\n• Sensibilisation chefs villages\n• Mesures distances axes routiers\n• Documentation contraintes terrain',
        'Jour 4 : Négociations Entrepreneurs\n• Séance travail bordereaux prix\n• Signature protocoles entente\n• Clarifier normes qualité\n• Convenir délais exécution',
        'Jour 5 : Consolidation & Logistique\n• Upload données SIG KoboToolbox\n• Audit inventaire matériels\n• Débriefing chef équipe\n• Préparation documents finaux',
        'Jour 6 : Repli vers Dakar\n• Inventaire final base vie\n• Trajet retour\n• Débriefing direction\n• Archivage rapports',
      ],
