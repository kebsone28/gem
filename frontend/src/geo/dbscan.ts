...
export function dbscan(points: SpatialPoint[], tree: RBush<RBushItem>, epsKm: number = 0.15, minPts: number = 5): SpatialPoint[][] {
...
export function isochroneDbscan(points: SpatialPoint[], timeMatrix: number[][], epsTime: number = 300, minPts: number = 3): SpatialPoint[][] {
    const clusters: SpatialPoint[][] = [];
