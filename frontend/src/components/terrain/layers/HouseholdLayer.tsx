    ...
    map.addLayer({
      ...
      paint: {
        ...
        'fill-opacity': [
          ...
          [
            'case',
            ['>', ['to-number', ['get', 'critical_count'], 0], 0],
            0.11,
            ['>', ['to-number', ['get', 'blocked_count'], 0], 0],
            0.09,
            ['>', ['to-number', ['get', 'pending_count'], 0], 0],
            0.075,
            ['==', ['to-number', ['get', 'compliant_count'], 0], ['to-number', ['get', 'point_count'], 0]],
            0.032,
            0.05,
          ],
          13.5,
