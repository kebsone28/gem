...
export function GeoJsonOverlayPanel({ isDarkMode = true }: { isDarkMode?: boolean }) {
  ...
  return (
    <motion.div
      ...
      className={`absolute bottom-[132px] left-3 right-3 top-auto z-30 flex max-h-[calc(100dvh-11rem)] flex-col overflow-hidden rounded-2xl border shadow-2xl backdrop-blur-sm md:bottom-auto md:left-auto md:right-4 md:top-20 md:w-72 md:max-h-[calc(100dvh-7rem)] ${bg}`}
    >
      {/* Header */}
