    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h4 className="text-xs font-black uppercase tracking-[0.2em] opacity-50 italic">Analytique</h4>
            ...
            <div className="space-y-4">
                ...
                <div className="pt-4 mt-2 border-t border-gray-100 dark:border-white/5">
                    <div className="flex justify-between items-end">
                        <span className="text-xs font-black uppercase tracking-[0.2em] opacity-40 italic leading-none">Taux de Livraison</span>
