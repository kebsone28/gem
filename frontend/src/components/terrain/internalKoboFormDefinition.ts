...
export const INTERNAL_KOBO_SECTIONS: InternalKoboSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'Nombre_de_KIT_Charg_pour_livraison', type: 'integer', label: 'Nombre de KIT charge pour livraison' },
      { name: 'Situation_du_M_nage', type: 'select_one', listName: 'cj3rh91', label: 'Situation du menage', relevant: "${role} = 'livreur'" },
      { name: 'justificatif', type: 'select_multiple', listName: 'pr4rq21', label: 'Justificatif', relevant: "${Situation_du_M_nage} = 'menage_non_eligible'" },
      { name: 'Longueur_Cable_2_5mm_Int_rieure', type: 'integer', label: 'Longueur cable 2,5mm2 interieure', required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
      { name: 'Longueur_Cable_1_5mm_Int_rieure', type: 'integer', label: 'Longueur cable 1,5mm2 interieure', required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
      { name: 'Longueur_Tranch_e_Cable_arm_4mm', type: 'integer', label: 'Longueur tranchee cable arme 4mm2', required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
      { name: 'Longueur_Tranch_e_C_ble_arm_1_5mm', type: 'integer', label: 'Longueur tranchee cable arme 1,5mm2', required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
      { name: 'Je_confirme_la_remis_u_materiel_au_m_nage', type: 'acknowledge', label: 'Je confirme la remise du materiel au menage', required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
      { name: 'Je_confirme_le_marqu_osition_des_coffrets', type: 'acknowledge', label: 'Je confirme le marquage du mur et des coffrets', required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
      { name: 'Presence_de_Mur', type: 'select_one', listName: 'pg7bi79', label: 'Presence de mur' },
      { name: 'Je_confirme_le_marqu_coffrets_lectriques', type: 'acknowledge', label: "Je confirme le marquage de l'emplacement des coffrets electriques", required: true, relevant: "${Situation_du_M_nage} = 'menage_eligible'" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'problemes_kit_macon', type: 'select_multiple', listName: 'problemes_kit_macon', label: 'Pourquoi ?', relevant: "${kit_disponible_macon} = 'non'" },
      { name: 'type_mur_realise_macon', type: 'select_one', listName: 'type_mur', label: 'Type de mur', required: true, relevant: "${kit_disponible_macon} = 'oui'" },
      { name: 'problemes_travail_macon', type: 'select_multiple', listName: 'problemes_travail_macon', label: 'Probleme', relevant: "${kit_disponible_macon} = 'oui'" },
      { name: 'validation_macon_final', type: 'acknowledge', label: 'Je valide que le mur est termine et conforme', required: true, relevant: "${type_mur_realise_macon} != ''" },
    ],
  },
  {
    id: 'reseau',
    ...
    fields: [
      ...
      { name: 'problemes_mur_reseau', type: 'select_multiple', listName: 'problemes_mur_reseau', label: 'Problemes avec le mur', required: true, relevant: "${verification_mur_reseau} = 'non'" },
      { name: 'etat_branchement_reseau', type: 'select_one', listName: 'etat_branchement', label: 'Etat du branchement', required: true, relevant: "${verification_mur_reseau} = 'oui'" },
      { name: 'problemes_branchement_reseau', type: 'select_multiple', listName: 'problemes_branchement_reseau', label: 'Problemes lors du branchement', relevant: "${etat_branchement_reseau} = 'probleme'" },
      { name: 'validation_reseau_final', type: 'acknowledge', label: 'Je valide que le branchement est termine et conforme', required: true, relevant: "${etat_branchement_reseau} = 'termine'" },
    ],
  },
  {
    id: 'interieur',
    ...
    fields: [
      ...
      { name: 'problemes_branchement_interieur', type: 'select_multiple', listName: 'problemes_branchement_interieur', label: 'Problemes avec le branchement', relevant: "${verification_branchement_interieur} = 'non'" },
      { name: 'etat_installation_interieur', type: 'select_one', listName: 'etat_installation', label: "Etat de l'installation interieure realisee", required: true, relevant: "${verification_branchement_interieur} = 'oui'" },
      { name: 'problemes_installation_interieur', type: 'select_multiple', listName: 'problemes_installation_interieur', label: "Problemes lors de l'installation interieure", relevant: "${etat_installation_interieur} = 'probleme'" },
      { name: 'validation_interieur_final', type: 'acknowledge', label: "Je valide que l'installation interieure est terminee et conforme", required: true, relevant: "${etat_installation_interieur} = 'termine'" },
    ],
  },
  {
    ...
    role: 'controleur',
    fields: [
      { name: 'ETAT_DE_L_INSTALLATION', type: 'select_one', listName: 'rr4dg37', label: 'Controle prealable', required: true },
      { name: 'controleurPROB', type: 'select_multiple', listName: 'oo84j36', label: 'Quel est le probleme ?', required: true, relevant: "${ETAT_DE_L_INSTALLATION} = 'probleme_a_signaler'" },
      { name: 'Phase_de_controle', type: 'select_one', listName: 'ga7rh54', label: 'Phase du controle', required: true, relevant: "${ETAT_DE_L_INSTALLATION} = 'terminee'" },
      { name: 'ETAT_BRANCHEMENT', type: 'select_one', listName: 'sv3tg34', label: 'Etat du branchement', required: true, relevant: "${ETAT_DE_L_INSTALLATION} = 'terminee' or ${ETAT_DE_L_INSTALLATION} = 'non_terminee'" },
      { name: 'OBSERVATION', type: 'select_multiple', listName: 'kx9fr02', label: 'Observation', required: true, relevant: "${ETAT_BRANCHEMENT} = 'non_termine'" },
      { name: 'Position_du_branchement', type: 'select_one', listName: 'lo9ia24', label: 'Position et longueur du branchement sur le reseau', required: true },
      { name: 'Observations_sur_la_ition_du_branchement', type: 'select_multiple', listName: 'la7vc77', label: 'Observations sur la position du branchement', required: true, relevant: "${Position_du_branchement} = 'non_conforme'" },
      { name: 'Hauteur_branchement', type: 'select_one', listName: 'nk1mo89', label: 'Hauteur branchement', required: true },
      { name: 'Observations', type: 'text', label: 'Observations', required: true, relevant: "${Hauteur_branchement} = 'non_conforme'" },
      { name: 'Hauteur_coffret', type: 'select_one', listName: 'nk1mo89', label: 'Hauteur du coffret', required: true },
      { name: 'Observations_001', type: 'text', label: 'Observations', required: true, relevant: "${Hauteur_coffret} = 'non_conforme'" },
      { name: 'Etat_du_coupe_circuit', type: 'select_one', listName: 'ur9iq73', label: 'Etat du coupe circuit ?' },
      { name: 'OBSERVATION_001', type: 'select_multiple', listName: 'rz78v01', label: 'Observation', required: true, relevant: "${Etat_du_coupe_circuit} = 'nc'" },
      { name: 'Continuit_PVC', type: 'select_one', listName: 'nk1mo89', label: 'Isolation coffret et protection descente cable', required: true },
      { name: 'OBSERVATION_002', type: 'select_multiple', listName: 'fv5uq33', label: 'Observation', required: true, relevant: "${Continuit_PVC} = 'non_conforme'" },
      { name: 'Mise_en_oeuvre', type: 'select_one', listName: 'nk1mo89', label: 'Mise en oeuvre du branchement', required: true },
      { name: 'OBSERVATION_003', type: 'select_multiple', listName: 'ey6uw71', label: 'Observation', required: true, relevant: "${Mise_en_oeuvre} = 'non_conforme'" },
      { name: '_1_photo_anomalie_si_possible', type: 'image', label: '1 photo anomalie si possible' },
    ],
  },
  {
    ...
    role: 'controleur',
    fields: [
      { name: 'DISJONCTEUR_GENERAL_EN_TETE_D_', type: 'select_one', listName: 'el0wa18', label: "Disjoncteur general en tete d'installation", required: true, hint: 'Verifier conformite materiel, mise en oeuvre, coupure generale, calibre et emplacement du coffret.' },
      { name: 'OBSERVATIONS_', type: 'select_multiple', listName: 'zs4mw04', label: 'Observations', required: true, relevant: "${DISJONCTEUR_GENERAL_EN_TETE_D_} = 'non_conforme'" },
      { name: 'TYPE_DE_DISJONCTEUR_GENERAL', type: 'select_one', listName: 'nr78z46', label: 'Type de disjoncteur general', required: true, relevant: "${DISJONCTEUR_GENERAL_EN_TETE_D_} = 'conforme'" },
      { name: 'ENSEMBLE_DE_L_INSTALLATION_PRO', type: 'select_one', listName: 'gk2qz88', label: "Ensemble de l'installation protege par DDR 30mA", required: true },
      { name: 'OBSERVATIONS__001', type: 'select_multiple', listName: 'py9cc56', label: 'Observations', required: true, relevant: "${ENSEMBLE_DE_L_INSTALLATION_PRO} = 'non_conforme'" },
      { name: 'PROTECTION_L_ORIGINE_DE_CHAQ', type: 'select_one', listName: 'nm4md59', label: "Protection a l'origine de chaque circuit", required: true },
      { name: 'OBSERVATIONS_002', type: 'select_multiple', listName: 'nr8tv95', label: 'Observations', required: true, relevant: "${PROTECTION_L_ORIGINE_DE_CHAQ} = 'non_conforme'" },
      { name: 'S_PARATION_DES_CIRCUITS_Lumi_', type: 'select_one', listName: 'nm4md59', label: 'Separation des circuits lumiere et prise', required: true },
      { name: 'OBSERVATIONS__002', type: 'text', label: 'Observations', required: true, relevant: "${S_PARATION_DES_CIRCUITS_Lumi_} = 'non_conforme'" },
      { name: 'PROTECTION_CONTRE_LES_CONTACTS', type: 'select_one', listName: 'bm2rn03', label: 'Protection contre les contacts directs', required: true },
      { name: 'OBSERVATIONS__003', type: 'select_multiple', listName: 'ps4nb23', label: 'Observations', required: true, relevant: "${PROTECTION_CONTRE_LES_CONTACTS} = 'non_conforme'" },
      { name: 'MISE_EN_OEUVRE_MAT_RIEL_ET_APP', type: 'select_one', listName: 'nm4md59', label: 'Mise en oeuvre materiel et appareillage', required: true },
      { name: 'OBSERVATIONS__004', type: 'select_multiple', listName: 'jm8qy41', label: 'Observations', required: true, relevant: "${MISE_EN_OEUVRE_MAT_RIEL_ET_APP} = 'non_conforme'" },
      { name: 'CONTINUITE_DE_LA_PROTECTION_ME', type: 'select_one', listName: 'nm4md59', label: 'Continuite de la protection mecanique des conducteurs', required: true },
      { name: 'OBSERVATIONS__005', type: 'select_multiple', listName: 'vo5kj15', label: 'Observations', required: true, relevant: "${CONTINUITE_DE_LA_PROTECTION_ME} = 'non_conforme'" },
      { name: 'MISE_EN_UVRE_DU_R_SEAU_DE_TER', type: 'select_one', listName: 'nm4md59', label: 'Mise en oeuvre du reseau de terre et continuite', required: true },
      { name: 'OBSERVATIONS__006', type: 'select_multiple', listName: 'pi0xx78', label: 'Observations', required: true, relevant: "${MISE_EN_UVRE_DU_R_SEAU_DE_TER} = 'non_conforme'" },
      { name: 'ETAT_DE_LA_BARRETTE_DE_TERRE', type: 'select_one', listName: 'lk4xz51', label: 'Etat de la barrette de terre' },
      { name: 'VALEUR_DE_LA_RESISTANCE_DE_TER', type: 'select_one', listName: 'nm4md59', label: 'Valeur de la resistance de terre ou de boucle', required: true },
      { name: 'OBSERVATIONS__007', type: 'integer', label: 'Valeur mesuree / observation', required: true, relevant: "${VALEUR_DE_LA_RESISTANCE_DE_TER} != ''" },
      { name: 'validation_controleur_final', type: 'acknowledge', label: 'Je confirme avoir tout controle', required: true, relevant: "${OBSERVATIONS__007} != ''" },
      { name: 'notes_generales', type: 'text', label: 'Notes generales', required: true },
    ],
  },
];
