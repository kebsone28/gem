    ...
    const handleDownload = async (region: Region) => {
        ...
        try {
            ...
            for (let z = 10; z <= 14; z++) {
                ...
                const yMin = Math.floor((1 - Math.log(Math.tan(latMax * Math.PI / 180) + 1 / Math.cos(latMax * Math.PI / 180)) / Math.PI) / 2 * Math.pow(2, z));
                const yMax = Math.floor((1 - Math.log(Math.tan(latMin * Math.PI / 180) + 1 / Math.cos(latMin * Math.PI / 180)) / Math.PI) / 2 * Math.pow(2, z));
                    ...
                    return (
                        ...
                        >
                            <div>
                                ...
                                <span className="text-xs text-slate-400 font-black uppercase tracking-widest">{region.sizeEstimate}</span>
                            </div>
