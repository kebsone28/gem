...
export const GeofencingAlerts: React.FC<GeofencingAlertsProps> = ({ households, grappesConfig, isDarkMode }) => {
    ...
    return (
        <div
            className={`absolute top-4 right-4 z-[300] w-80 rounded-2xl border shadow-2xl backdrop-blur-xl overflow-hidden transition-all ${isDarkMode ? 'bg-rose-950/95 border-rose-800/60' : 'bg-rose-50/95 border-rose-200'
                }`}
        >
            {/* Header */}
