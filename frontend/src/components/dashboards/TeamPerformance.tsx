    ...
    if (!teamStats || teamStats.length === 0) {
        return (
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[20px] border border-gray-100 shadow-sm dark:shadow-none text-center">
                ...
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Aucune donnée de performance</p>
            </div>
        );
    }
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[20px] border border-gray-100 shadow-sm dark:shadow-none space-y-8">
            ...
            <div className="pt-4 grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50/50 p-4 rounded-xl border border-gray-100 text-center">
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Moyenne Rendement</p>
                </div>
            </div>
        </div>
    );
