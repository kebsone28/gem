...
export function MissionSettings({ features, onToggle }: MissionSettingsProps) {
    const featureLabels = [
        { id: 'map', label: 'Mini-Carte SIG', icon: Map, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'Visualisation de l\'itinéraire et des grappes.' },
        { id: 'expenses', label: 'Gestion des Frais', icon: DollarSign, color: 'text-emerald-500', bg: 'bg-emerald-500/10', desc: 'Carburant, justificatifs et calculs auto.' },
        { id: 'inventory', label: 'Inventaire & Checklist', icon: ListChecks, color: 'text-amber-500', bg: 'bg-amber-500/10', desc: 'Matériel emporté et vérifications départ.' },
        { id: 'ai', label: 'Outils IA', icon: Sparkles, color: 'text-purple-500', bg: 'bg-purple-500/10', desc: 'Estimation de charge et conclusion auto.' }
    ];
