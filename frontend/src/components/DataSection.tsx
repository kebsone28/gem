...
export function DataSection({ project, households }: { project: any, households: any[], onUpdate: any }) {
    ...
    const handleReorganizeGrappes = async () => {
        ...
        if (!window.confirm(`Lancer le recalcul spatial sur le serveur pour ${households.length} ménages ? Cette action mettra à jour la carte et le bordereau.`)) return;
    ...
    return (
        <div className="space-y-12">
            <div>
                ...
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Outils avancés de gestion de la base de données locale</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white/5 p-8 rounded-[2.5rem] border border-white/5 space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xs font-black text-white uppercase tracking-widest">Réorganisation des Grappes</h3>
                            <p className="text-rose-500/60 text-[10px] font-black uppercase tracking-[0.2em]">Calcul spatial basé sur les coordonnées</p>
                        </div>
                    </div>
                    <p className="text-[11px] text-slate-400 font-bold uppercase leading-relaxed">
                        Recalcule automatiquement les grappes et sous-grappes à partir des coordonnées GPS des ménages synchronisés.
                    </p>
                    <button 
                ...
                <div className="bg-white/5 p-8 rounded-[2.5rem] border border-white/5 space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xs font-black text-white uppercase tracking-widest">Réinitialisation Cache</h3>
