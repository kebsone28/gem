...
const HOME_THEME = {
  ...
  gem: {
    pageGradient: 'from-slate-950 via-[#0a0e2a] to-slate-950',
    orbTop: 'bg-indigo-500/12',
    orbBottom: 'bg-blue-500/10',
    logoGradient: 'from-indigo-400 to-blue-500',
    logoShadow: 'shadow-indigo-500/20',
    indicator: 'bg-indigo-400',
    linkText: 'text-indigo-300 hover:text-indigo-200',
    heroGradient: 'from-indigo-300 via-blue-400 to-sky-300',
    primaryButton: 'bg-indigo-500 hover:bg-indigo-400 shadow-indigo-500/20',
    searchFocus: 'group-focus-within:text-indigo-300',
    filterActive: 'bg-indigo-500 text-white border-indigo-400 shadow-lg shadow-indigo-500/20',
    toggleActive: 'bg-indigo-500 text-white shadow-lg',
    emptyBadge: 'text-indigo-200',
    emptyButtonHover: 'hover:bg-indigo-500',
    cardHoverBorder: 'hover:border-indigo-400/30',
    cardOverlay: 'group-hover:from-indigo-500/10 group-hover:via-blue-500/5 group-hover:to-sky-400/5',
    cardTitleHover: 'group-hover:text-indigo-200',
    cardEditHover: 'hover:bg-indigo-500',
    cardArrow: 'group-hover:text-indigo-300',
    cardArrowBg: 'group-hover:bg-indigo-500/10',
    progressGradient: 'from-indigo-400 to-blue-500',
    floatingCta: 'bg-indigo-500 shadow-indigo-500/40',
    heroAccent: 'text-indigo-200',
    stats: [
      { color: 'from-indigo-500/20 to-blue-500/5', border: 'border-indigo-500/20', text: 'text-indigo-300' },
      { color: 'from-emerald-500/20 to-cyan-500/5', border: 'border-emerald-500/20', text: 'text-emerald-300' },
      { color: 'from-blue-500/20 to-indigo-500/5', border: 'border-blue-500/20', text: 'text-blue-300' },
