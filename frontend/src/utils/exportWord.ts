              ...
              children: [
                new Paragraph({
                  ...
                  children: [
                    ...
                    new TextRun({
                      text: `PRQ-2026-${Math.random().toString(36).substring(7).toUpperCase()}`,
                    }),
                  ],
                }),
              ],
...
const createRoleSection = async (data: ExportData) => {
        ...
        new TableRow({
          children: [
            new TableCell({
              ...
              children: [
                new Paragraph({
                  children: [new TextRun({ text: 'RESPONSABLE', bold: true, size: 18 })],
                }),
              ],
            ...
            new TableCell({
              children: [
                //@ts-ignore
                new Paragraph({ text: responsible || 'Non assigné', size: 18 }) as any,
              ],
              width: { size: 25, type: WidthType.PERCENTAGE },
            }),
            new TableCell({
              ...
              children: [
                new Paragraph({
                  children: [new TextRun({ text: 'PÉRIODE', bold: true, size: 18 })],
                }),
              ],
              width: { size: 25, type: WidthType.PERCENTAGE },
            }),
            ...
            new TableCell({
              children: [
                //@ts-ignore
                new Paragraph({ text: `${startDate} au ${endDate}`, size: 18 }) as any,
              ],
              width: { size: 25, type: WidthType.PERCENTAGE },
            }),
          ],
  ...
  // Introduction
  children.push(
    createSectionHeader('1. Objet du Contrat et Obligations de Résultat', COLORS.SECONDARY)
  );
  children.push(
    new Paragraph({
      children: [new TextRun({ text: introduction, color: COLORS.SECONDARY, italics: true })],
  ...
  const materialRows = materials.map(
    (m) =>
      new TableRow({
        children: [
          new TableCell({
  ...
  if (pricing) {
    ...
    const headerRow = new TableRow({
      children: ['Désignation', 'Qté', 'Durée (j)', 'P.U (FCFA)', 'TOTAL (FCFA)'].map(
        (h) =>
          new TableCell({
            shading: { fill: COLORS.BG_LIGHT },
            ...
            children: [
              new Paragraph({
                alignment: AlignmentType.CENTER,
                children: [new TextRun({ text: h, bold: true, color: COLORS.SECONDARY })],
              }),
            ],
          })
      ),
    ...
    const dataRow = new TableRow({
      children: [
        ...
        new TableCell({
          ...
          children: [
            new Paragraph({
              text: pricing.personnelCount.toString(),
              //@ts-ignore
              alignment: AlignmentType.CENTER,
            }),
          ],
        ...
        new TableCell({
          ...
          children: [
            new Paragraph({
              text: pricing.durationDays.toString(),
              //@ts-ignore
              alignment: AlignmentType.CENTER,
            }),
          ],
        ...
        new TableCell({
          ...
          children: [
            new Paragraph({
              text: pricing.dailyRate.toLocaleString(),
              alignment: AlignmentType.CENTER,
            }),
          ],
        }),
        new TableCell({
          ...
          children: [
            new Paragraph({
              alignment: AlignmentType.CENTER,
              children: [
                new TextRun({ text: totalValue.toLocaleString(), bold: true, color: COLORS.WHITE }),
              ],
            }),
          ],
        }),
    ...
    children.push(
      new Paragraph({
        ...
        children: [
          ...
          new TextRun({
            text: `${totalValue.toLocaleString()} ${pricing.currency}`,
            bold: true,
            size: 32,
            color: COLORS.PRIMARY,
          }),
            ...
            new TableCell({
              children: [
                new Paragraph({
                  ...
                  children: [
                    new TextRun({
                      text: 'VISA DIRECTION GENERALE PROQUELEC',
                      bold: true,
                      size: 20,
                    }),
                  ],
            ...
            new TableCell({
              children: [
                new Paragraph({
                  ...
                  children: [
                    new TextRun({
                      text: `VISA TITULAIRE (${role.toUpperCase()})`,
                      bold: true,
                      size: 20,
                    }),
                  ],
...
export const exportCahiersToWord = async (
  ...
  const fileName = isMultiple
    ...
    : `BORDEREAU_${tasks[0].role.replace(/\s+/g, '_')}_PRQ.docx`;
