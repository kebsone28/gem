...
// 1️⃣ RÉFÉRENTIEL DES RÔLES PAR ENTREPRISE
export const ROLES = {
  // CLIENT LSE
...
export const ROLE_ALIASES: Record<string, UserRole> = {
  ...
  SUPERVISEUR_LSE: ROLES.CLIENT_LSE_SUPERVISEUR,
  TECHNICIEN_LSE: ROLES.CLIENT_LSE_TECHNIQUE,
  
  // PROQUELEC/GEM
  ADMIN_PROQUELEC: ROLES.PROQUELEC_ADMIN,
  ADMINISTRATEUR: ROLES.PROQUELEC_ADMIN,
  ADMIN: ROLES.PROQUELEC_ADMIN,
  
  DG_PROQUELEC: ROLES.PROQUELEC_DG,
  'DIRECTION GÉNÉRALE': ROLES.PROQUELEC_DG,
  DIRECTEUR: ROLES.PROQUELEC_DG,
  DG: ROLES.PROQUELEC_DG,
  
  CHEF_PROJET: ROLES.PROQUELEC_CHEF_PROJET,
  'CHEF DE PROJET': ROLES.PROQUELEC_CHEF_PROJET,
  CP: ROLES.PROQUELEC_CHEF_PROJET,
  
  CHEF_EQUIPE: ROLES.PROQUELEC_DIRECTION,
  'CHEF DE CHANTIER': ROLES.PROQUELEC_DIRECTION,
  CHEF: ROLES.PROQUELEC_DIRECTION,
  ...
  // SENELEC
  SUPERVISEUR_SENELEC: ROLES.SENELEC_SUPERVISEUR,
  CONTROLEUR_SENELEC: ROLES.SENELEC_CONTROLEUR,
  
  // SOUS-TRAITANTS
  DIRECTEUR_SOUS_TRAITANT: ROLES.SOUS_TRAITANT_DIRECTEUR,
  EMPLOYE_SOUS_TRAITANT: ROLES.SOUS_TRAITANT_EMPLOYE,
};
...
// 4️⃣ MATRICE DE DROITS PAR DÉFAUT - MULTI-ENTREPRISES
