...
export const DESIGN_TOKENS = {
  ...
  gradients: {
    ...
    darkSubtle:
      'linear-gradient(135deg, rgba(30, 144, 255, 0.10) 0%, rgba(0, 102, 255, 0.05) 100%)',
  },
...
export const getGradient = (key: keyof typeof DESIGN_TOKENS.gradients) =>
  DESIGN_TOKENS.gradients[key];
export const getFontSize = (key: keyof typeof DESIGN_TOKENS.typography.sizes) =>
  DESIGN_TOKENS.typography.sizes[key];
export const getFontWeight = (key: keyof typeof DESIGN_TOKENS.typography.weights) =>
  DESIGN_TOKENS.typography.weights[key];
...
export const COMMON_CLASSES = {
  ...
  label: 'block text-xs font-semibold uppercase tracking-[0.06em] ' + 'text-blue-300/40 mb-1.5',
  ...
  body: 'text-[0.9375rem] leading-relaxed ' + 'text-blue-200/60',

  caption: 'text-xs ' + 'text-blue-300/40',

  overline: 'text-[0.7rem] font-bold uppercase tracking-[0.10em] ' + 'text-blue-300/40',
  ...
  // ── DIVIDERS ─────────────────────────────────────────────────────────────
  divider: 'h-px bg-gradient-to-r from-transparent via-[rgba(30,144,255,0.25)] to-transparent my-6',

  dividerSolid: 'h-px bg-white/5 my-4',
} as const;
